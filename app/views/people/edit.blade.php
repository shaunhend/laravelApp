...
{{ Form::model($person, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('people.update', $person->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('people.show', 'Cancel', $person->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
