...
{{ Form::open(array('route' => 'products.store', 'class' => 'form-horizontal')) }}
        ...
        <div class="form-group">
            {{ Form::label('reference', 'Reference Number:', array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('descript', 'Description:', array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('img', 'Image Upload:', array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('validto', 'Valid Until:', array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('minorder', 'Minimum Order:', array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
